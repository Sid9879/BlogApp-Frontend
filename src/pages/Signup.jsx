...
const Signup = () => {
  ...
  const handleSubmit = async (e)=>{
    ...
    // console.log(obj)
    let res = await axios.post('https://blogapp-anlu.onrender.com/users/create',obj)
  ...
  return (
    <div>
     ...
     <div className="font-[sans-serif] bg-white max-w-4xl flex items-center mx-auto md:h-screen p-4 z-50">
  <div className="grid md:grid-cols-3 items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl overflow-hidden">
    ...
    <form className="md:col-span-2 w-full py-6 px-6 sm:px-16 z-40">
...
<label className="text-gray-800 text-sm mb-2 block">Address</label>
          <div className="relative flex items-center">
            <input ref={addressRef} name="Address" type="text" required className="text-gray-800 bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded-md outline-blue-500" placeholder="Enter your address" />
            <svg xmlns="https://www.svgrepo.com/show/493957/address.svg" fill="#bbb" stroke="#bbb" className="w-4 h-4 absolute right-4" viewBox="0 0 24 24">
              <circle cx={10} cy={7} r={6} data-original="#000000" />
              <path d="M14 15H6a5 5 0 0 0-5 5 3 3 0 0 0 3 3h12a3 3 0 0 0 3-3 5 5 0 0 0-5-5zm8-4h-2.59l.3-.29a1 1 0 0 0-1.42-1.42l-2 2a1 1 0 0 0 0 1.42l2 2a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42l-.3-.29H22a1 1 0 0 0 0-2z" data-original="#000000" />
            </svg>
          </div>
      ...
      <div className="!mt-12">
        <button onClick={handleSubmit} type="button" className="w-full py-3 px-4 tracking-wider text-sm rounded-md text-white bg-gray-700 hover:bg-gray-800 focus:outline-none">
          Create an account
        </button>
      </div>
