    ...
    <div className="hidden bg-cover lg:block lg:w-2/3" style={{backgroundImage: 'url(https://images.unsplash.com/photo-1616763355603-9755a640a287?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80)'}}>
      <div className="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
        <div>
          ...
          <p className="max-w-xl mt-3 text-gray-300">Welcome to our BlogPage!
          Discover insightful articles, tips, and stories on topics of technology, lifestyle, travel, or personal growth. Our blog is a space for sharing knowledge, sparking creativity, and connecting with curious minds. Dive into engaging content crafted to inform, inspire, and entertain!</p>
        </div>
      </div>
    </div>
        ...
        <div className="mt-8">
          <form>
            ...
            <div className="mt-6">
              ...
              <input ref={passwordRef} type="password" maxLength={20} name="password" id="password" placeholder="Your Password" className="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
            </div>
            <div className="mt-6">
